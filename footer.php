    ...
    <div class="container">
        <div class="footer__container">
            <a href="/" class="footer__logo header__logo">
                <?php $footer_logo_white = get_field( 'footer_logo_white', 'option' ); ?>
                <?php $size = '158_50'; ?>
                <?php if ( $footer_logo_white ) : ?>
                    <?php
                    $attr = array('class' => 'header__logo-hover');
                    echo wp_get_attachment_image( $footer_logo_white, $size, false, $attr );
                    ?>
                <?php endif; ?>

                <?php $footer_logo_black = get_field( 'footer_logo_black', 'option' ); ?>
                <?php $size = '158_50'; ?>
                <?php if ( $footer_logo_black ) : ?>
                    <?php echo wp_get_attachment_image( $footer_logo_black, $size ); ?>
                <?php endif; ?>
            </a>
            <div class="footer__block">
                <nav class="footer__nav">
                    <?php raccocleaning_footer_menu(); ?>
                </nav>
            </div>
                            ...
                            <div class="socials">
                                <?php while ( have_rows( 'social_items' ) ) : the_row(); ?>
                                    <a href="<?php the_sub_field( 'social_link' ); ?>">
                                        <?php the_sub_field( 'social_image' ); ?>
                                    </a>
                                <?php endwhile; ?>
                            </div>
                        <?php endif; ?>
            ...
            <?php if ( have_rows( 'contact_info', 'option' ) ) : ?>
                <?php while ( have_rows( 'contact_info', 'option' ) ) : the_row(); ?>
                    <div class="footer__block">
                        ...
                        <?php if(get_sub_field( 'adress_info')) {?>
                            <address><?php the_sub_field( 'adress_info' ); ?></address>
                        <?php } ?>

                        <?php if(get_sub_field( 'developet_by')) {?>
                            <p class="developed-by"><?php the_sub_field( 'developet_by' ); ?></p>
                        <?php } ?>
                    </div>
                <?php endwhile; ?>
            <?php endif; ?>
        ...
        <div class="promo__form">
            <div class="promo__form-head">
                <div class="promo__form-title">
                    <h2><?php _e('Book a Cleaning', 'raccocleaning'); ?> </h2>
                </div>
                <div class="promo__form-text">
                    <p><?php _e('You can apply right now! And very soon our manager will contact you.', 'raccocleaning'); ?></p>
                </div>
            </div>
            <form class="promo__form-body popup_form" id="popup_form">
                <div class="promo__form-row">
                    <div class="promo__form-input">
                        <div class="input input--text ">
                            ...
                            <label><?php _e('Name', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                                <div class="input__validation-invalid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-cancel.svg" alt="" role="presentation">
                                </div>
                            </div>
                    ...
                    <div class="promo__form-input">
                        <div class="input input--text ">
                            ...
                            <label><?php _e('Phone number', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                ...
                <div class="promo__form-row">
                    <div class="promo__form-input">
                        <div class="input input--email ">
                            ...
                            <label><?php _e('Email', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                ...
                <div class="promo__form-subtitle">
                    <h3><?php _e('Address cleaning', 'raccocleaning'); ?></h3>
                </div>
                <div class="promo__form-row">
                    <div class="promo__form-input">
                        <div class="input input--text ">
                            <input type="text" name="address" required data-validation="address" placeholder=" ">
                            <label><?php _e('Address', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                ...
                <div class="promo__form-row">
                    <div class="promo__form-input">
                        <div class="input input--select ">
                            ...
                            <label><?php _e('Service', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                    ...
                    <div class="promo__form-input">
                        <div class="input input--text ">
                            ...
                            <label><?php _e('Square (Sq ft)', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                ...
                <div class="promo__form-row">
                    <div class="promo__form-input">
                        <div class="input input--number ">
                            ...
                            <label><?php _e('Bedrooms', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                            ...
                            <div class="input__number">
                                <div class="input__number-btn input__number-minus">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-btn-minus.svg" alt="-">
                                </div>
                                <div class="input__number-btn input__number-plus">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-btn-plus.svg" alt="+">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="promo__form-input">
                        <div class="input input--number ">
                            ...
                            <label><?php _e('Bathrooms', 'raccocleaning'); ?></label>
                            <div class="input__validation">
                                <div class="input__validation-valid">
                                    <img src="<?php echo TEMPLATE_DIRECTORY_URI; ?>/static/app/img/ico-checked.svg" alt="" role="presentation">
                                </div>
                ...
                <div class="promo__form-submit">
                    <button type="submit" class="button   "> <?php _e('Send', 'raccocleaning'); ?> </button>
                </div>
            </form>
        </div>
    </div>
