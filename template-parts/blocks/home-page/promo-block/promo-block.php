<section class="promo">
    <div class="promo__bg">
        <picture>
            <?php $promo_backgroud_image = get_field( 'promo_backgroud_image' ); ?>
            <?php $promo_backgroud_image_mobile = get_field( 'promo_backgroud_image_mobile' ); ?>

            <?php if ( $promo_backgroud_image ) : ?>
                <?php if ( $promo_backgroud_image_mobile ) : ?>
                    <source media="(max-width: 768px)" srcset="<?php echo esc_url( $promo_backgroud_image_mobile['url'] ); ?>" />
                <?php endif; ?>
                <source media="(min-width: 769px)" srcset="<?php echo esc_url( $promo_backgroud_image['url'] ); ?>" />
                <img src="<?php echo esc_url( $promo_backgroud_image['url'] ); ?>" alt="" role="presentation" />
            <?php endif; ?>
        </picture>
    </div>
    <div class="container">
        <div class="promo__container">
            ...
            <div class="promo__form">
                <div class="promo__form-head">
                    <?php if (get_field( 'promo_form_title' )) { ?>
                        <div class="promo__form-title">
                            <h2><?php the_field( 'promo_form_title' ); ?> </h2>
                        </div>
                    <?php } ?>

                    <?php if (get_field( 'promo_form_desc' )) { ?>
                        <div class="promo__form-text">
                            <?php the_field( 'promo_form_desc' ); ?>
                        </div>
                    <?php } ?>
                </div>
                <form class="promo__form-body booking_form" id="form_promo">
