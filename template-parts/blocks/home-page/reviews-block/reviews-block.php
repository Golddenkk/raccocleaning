                                ...
                                <article class="reviews__item">
                                    <div class="reviews__item-info">
                                        <div class="reviews__item-author">
                                            <?php $reviewer_avatar = get_sub_field( 'reviewer_avatar' ); ?>
                                            <?php $size = '45_45'; ?>
                                            <?php if ( $reviewer_avatar ) : ?>
                                                <div class="reviews__item-author__avatar">
                                                    <?php echo wp_get_attachment_image( $reviewer_avatar, $size ); ?>
                                                </div>
                                            <?php endif; ?>

                                            <?php if (get_sub_field( 'reviewer_name' )) { ?>
                                                <div class="reviews__item-author__name">
                                                    <h3><?php the_sub_field( 'reviewer_name' ); ?></h3>
                                                </div>
                                            <?php } ?>
                                        </div>
                                        <div class="reviews__item-rating">
                                            <?php
                                            $stars_count = floatval(get_sub_field('stars_count'));
                                            $integer_part = intval($stars_count);
                                            $decimal_part = $stars_count - $integer_part;
                                            ...
                                            if ($decimal_part > 0) {
                                                if ($decimal_part >= 0.7) {
                                                    $integer_part++;
                                                } elseif ($decimal_part >= 0.3) {
                                                    $class = 'rating-half';
                                                }
                                            }
                                            ?>
                                            <div class="reviews__item-rating__stars rating-<?= $integer_part; ?> <?= $class; ?>">
                                            ...
                                            <?php $formatted_stars_count = number_format((float)get_sub_field( 'stars_count' ), 1, '.', ''); ?>
                                            <span><?php echo $formatted_stars_count; ?></span>
                                        </div>
                                    </div>
                                    <?php if (get_sub_field( 'description' )) { ?>
                                        <div class="reviews__item-content">
                                            <q> <?php the_sub_field( 'description' ); ?> </q>
                                        </div>
                                    <?php } ?>
